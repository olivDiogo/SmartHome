...
public class AddSensorToDeviceControllerTest {
    ...
    void shouldCreateAddSensorToDeviceController() throws InstantiationException {
        ...
        //Act
        new AddSensorToDeviceController(roomService, roomAssembler, deviceService, deviceAssembler, sensorModelService, sensorModelAssembler, sensorTypeService, sensorTypeAssembler, sensorAssembler, sensorService);
    }

    /**
     * Test to check if the AddSensorToDeviceController is returning null when the RoomService is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the RoomAssembler is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the DeviceService is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the DeviceAssembler is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorModelService is null.
     */
    @Test
    void shouldReturnNull_whenSensorModelServiceIsNull() throws InstantiationException {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> new AddSensorToDeviceController(roomService, roomAssembler, deviceService, deviceAssembler, null, sensorModelAssembler, sensorTypeService, sensorTypeAssembler, sensorAssembler, sensorService));
        assertEquals(expectedMessage, exception.getMessage());
    }

    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorModelAssembler is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the ConfigurationService is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning an empty list when there are no rooms.
     */
    @Test
    void shouldReturnEmptyList_whenThereAreNoRooms() throws InstantiationException {
        ...
        AddSensorToDeviceController addSensorToDeviceController = new AddSensorToDeviceController(roomService, roomAssembler, deviceService, deviceAssembler, sensorModelService, sensorModelAssembler, sensorTypeService, sensorTypeAssembler, sensorAssembler, sensorService);
    ...
    @Test
    public void shouldThrowException_WhenRoomIDDoesNotExistInRepository() throws InstantiationException {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        ImpRoomFactory roomFactory = new ImpRoomFactory();
        RoomAssembler roomAssembler = new RoomAssembler();
        ...
        // Act & Assert
        Exception exception = assertThrows(IllegalArgumentException.class, () -> addSensorToDeviceController.getDevicesFromRoom(roomDTO));
    ...
    void shouldGetAvailableSensorModelsList() throws InstantiationException {
        ...
        List<SensorModelDTO> sensorModelDTOList = addSensorToDeviceController.getSensorModels(sensorTypeDTO);

        List<SensorModel> sensorModels = sensorModelRepository.findAll();
        List<SensorModelDTO> expectedSensorModelDTOList = sensorModelAssembler.domainToDTO(sensorModels);

        //Assert
        assertEquals(expectedSensorModelDTOList.get(0).sensorModelID, sensorModelDTOList.get(0).sensorModelID);
    }
    ...
    void shouldThrowExceptionWhenSensorModelRepositoryIsEmpty() throws InstantiationException {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> addSensorToDeviceController.getSensorModels(sensorTypeDTO));
    ...
    void shouldThrowExceptionWhenSensorTypeRepositoryIsEmpty() throws InstantiationException {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> addSensorToDeviceController.getSensorTypes());
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorTypeService is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorTypeAssembler is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorAssembler is null.
     */
    @Test
    ...
    /**
     * Test to check if the AddSensorToDeviceController is returning null when the SensorService is null.
     */
    @Test
     ...
     */
    @Test
    void shouldReturnListOfSensorTypes_whenSensorTypeRepositoryIsNotEmpty() throws InstantiationException {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        ImpRoomFactory roomFactory = new ImpRoomFactory();
        RoomAssembler roomAssembler = new RoomAssembler();
        ...
        //Act
        AddSensorToDeviceController addSensorToDeviceController = new AddSensorToDeviceController(roomService, roomAssembler, deviceService, new DeviceAssembler(), sensorModelService, sensorModelAssembler, sensorTypeService, sensorTypeAssembler, sensorAssembler, sensorService);

        List<SensorTypeDTO> sensorTypeDTOList = addSensorToDeviceController.getSensorTypes();
        List<SensorTypeDTO> sensorTypeDTO = sensorTypeAssembler.domainToDTO(sensorTypeRepository.findAll());
    ...
    void shouldReturnEmptyList_whenThereAreNoSensorTypes() throws InstantiationException {
        ...
        SensorService sensorService = new SensorService(sensorRepository, sensorFactory, deviceRepository);
        RoomService roomService = new RoomService(roomRepository, roomFactory, roomAssembler, houseRepository);
        ConfigurationService configurationService = new ConfigurationService(sensorModelRepository, unitRepository, sensorModelFactory, new ImpUnitFactory());
        DeviceAssembler deviceAssembler = new DeviceAssembler();
        ...
        SensorType nonExistintSensorType = sensorTypeService.createSensorType(nonExistintTypeDescription, unitID);
        ...
        //Assert
        assertEquals("Sensor type with ID " + nonExistintTypeDescription + " not found.", exception.getMessage());
    }
    ...
    void shouldAddSensorToDevice_whenParametersAreValid() throws InstantiationException {
        ...
        SensorDataDTO sensorDataDTO = new SensorDataDTO(device.getID().getId(), modelPath, sensorName, sensorType.getID().getId());
