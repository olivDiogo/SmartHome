...
class LogServiceImplTest {
    ...
    /**
     * Test that the LogServiceImpl class throws an IllegalArgumentException when the LogRepository is null.
     */
    @Test
    void shouldThrowIllegalArgumentExceptionWhenLogRepositoryIsNull() {
        ...
        // Act
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new LogServiceImpl(logRepository));
        // Assert
