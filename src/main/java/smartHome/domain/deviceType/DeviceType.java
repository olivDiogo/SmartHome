...
public class DeviceType implements IAggregateRoot<DeviceTypeID> {
  ...
  protected DeviceType(DeviceTypeID id, TypeDescription description) {
    _deviceTypeID = id;
    _deviceTypeDescription = description;
  }

  /**
   * Validates the device type description. If the device type description is null, an exception is
   * thrown.
   *
