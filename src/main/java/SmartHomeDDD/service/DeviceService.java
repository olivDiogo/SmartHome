...
public class DeviceService {
    private final IDeviceRepo _deviceRepository;
     ...
     */
    public DeviceService(IDeviceRepo deviceRepository, IDeviceFactory deviceFactory, Repository<RoomID, Room> roomRepository) {
