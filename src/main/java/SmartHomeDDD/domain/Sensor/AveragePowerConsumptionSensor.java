...
public class AveragePowerConsumptionSensor implements Sensor {
     ...
     */
    public AveragePowerConsumptionSensor(DeviceID deviceID, ModelPath modelPath, SensorTypeID sensorTypeID, SensorName sensorName) throws InstantiationException {
