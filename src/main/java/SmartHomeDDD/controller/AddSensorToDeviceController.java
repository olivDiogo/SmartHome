...
import static SmartHomeDDD.assembler.DataAssembler.convertSensorDataToParameters;
...
public class AddSensorToDeviceController {
  ...
  //
  //        ISensor sensor = _sensorService.addSensor(deviceID, modelPath, sensorTypeID,
  // sensorName);
  //
  ...
  public SensorDTO addSensorToDevice(SensorDataDTO sensorDataDTO) {
    // Convert SensorDataDTO to Object[] parameters
    validateSensorDataDTO(sensorDataDTO);
    Object[] convertedParameters = convertSensorDataToParameters(sensorDataDTO);

    ISensor sensor = _sensorService.addSensor(convertedParameters);
