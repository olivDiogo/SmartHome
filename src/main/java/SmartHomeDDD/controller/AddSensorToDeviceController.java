...
public class AddSensorToDeviceController {
     ...
     */
    public AddSensorToDeviceController(RoomService roomService,
    ...
    public List<SensorModelDTO> getSensorModels(SensorTypeDTO sensorTypeDTO) {
        ...
        List<SensorModel> sensorModels = _sensorModelService.getSensorModelsBySensorTypeId(sensorTypeID);
